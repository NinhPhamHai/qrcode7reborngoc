.class public Lcom/qrcode/scanner/generator/utils/AppLocationUtils;
.super Ljava/lang/Object;
.source "AppLocationUtils.java"
...
.field private static appLocationUtils:Lcom/qrcode/scanner/generator/utils/AppLocationUtils;
...
.method private constructor <init>(Landroid/app/Activity;)V
    ...
    .line 55
    iput-object p1, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->mContext:Landroid/content/Context;

    return-void
.end method

.method public static declared-synchronized getInstance(Landroid/app/Activity;)Lcom/qrcode/scanner/generator/utils/AppLocationUtils;
    .locals 2

    const-class v0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;

    monitor-enter v0

    .line 59
    :try_start_0
    sget-object v1, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->appLocationUtils:Lcom/qrcode/scanner/generator/utils/AppLocationUtils;

    if-nez v1, :cond_0

    .line 60
    new-instance v1, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;

    invoke-direct {v1, p0}, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;-><init>(Landroid/app/Activity;)V

    sput-object v1, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->appLocationUtils:Lcom/qrcode/scanner/generator/utils/AppLocationUtils;

    .line 62
    :cond_0
    sget-object p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->appLocationUtils:Lcom/qrcode/scanner/generator/utils/AppLocationUtils;
    :try_end_0
...
.method private sendBroadCast()V
    ...
    .line 211
    iget-object v0, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->mContext:Landroid/content/Context;
...
.method public connectClient(Z)V
    ...
    .line 202
    iput-boolean p1, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->isLocationConfirmation:Z

    .line 203
    iget-object p1, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->mGoogleApiClient:Lcom/google/android/gms/common/api/GoogleApiClient;
...
.method public onConnected(Landroid/os/Bundle;)V
    ...
    .line 125
    :try_start_0
    iget-object p1, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->mContext:Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->mGoogleApiClient:Lcom/google/android/gms/common/api/GoogleApiClient;
    ...
    iput-object p1, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->location:Landroid/location/Location;
    ...
    iget-object v1, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->mLocationRequest:Lcom/google/android/gms/location/LocationRequest;

    invoke-interface {p1, v0, v1, p0}, Lcom/google/android/gms/location/FusedLocationProviderApi;->requestLocationUpdates(Lcom/google/android/gms/common/api/GoogleApiClient;Lcom/google/android/gms/location/LocationRequest;Lcom/google/android/gms/location/LocationListener;)Lcom/google/android/gms/common/api/PendingResult;

    .line 131
    iget-object p1, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->location:Landroid/location/Location;
    ...
    iget-object v0, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->location:Landroid/location/Location;
    ...
    invoke-virtual {p1, v0}, Lcom/qrcode/scanner/generator/utils/preferences/AppSharedPreference;->setLatitudeData(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0}, Lcom/qrcode/scanner/generator/utils/preferences/AppSharedPreference;->setLongitudeData(Ljava/lang/String;)V
    :try_end_0
...
.method public onConnectionFailed(Lcom/google/android/gms/common/ConnectionResult;)V
    ...
    .line 154
    :try_start_0
    iget-boolean v0, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->isLocationConfirmation:Z
...
.method public onLocationChanged(Landroid/location/Location;)V
    ...
    invoke-virtual {v0, v1}, Lcom/qrcode/scanner/generator/utils/preferences/AppSharedPreference;->setLatitudeData(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lcom/qrcode/scanner/generator/utils/preferences/AppSharedPreference;->setLongitudeData(Ljava/lang/String;)V

    .line 197
    invoke-virtual {p0}, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->stopFetchingLocation()V
...
.method public showLocationDialog()V
    ...
    iget-object v2, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->mGoogleApiClient:Lcom/google/android/gms/common/api/GoogleApiClient;
    ...
    .line 100
    new-instance v1, Lcom/qrcode/scanner/generator/utils/AppLocationUtils$1;

    invoke-direct {v1, p0}, Lcom/qrcode/scanner/generator/utils/AppLocationUtils$1;-><init>(Lcom/qrcode/scanner/generator/utils/AppLocationUtils;)V
...
.method public declared-synchronized startFetchingLocation(Landroid/content/Context;F)V
    ...
    .line 66
    :try_start_0
    sput p2, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->displacement:F
    ...
    iget-object p2, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->mContext:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->mGoogleApiClient:Lcom/google/android/gms/common/api/GoogleApiClient;

    const-string p1, ""

    .line 75
    iput-object p1, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->mAddressOutput:Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->mLocationRequest:Lcom/google/android/gms/location/LocationRequest;

    .line 78
    iget-object p1, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->mLocationRequest:Lcom/google/android/gms/location/LocationRequest;
    ...
    .line 82
    invoke-virtual {p0}, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->showLocationDialog()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public stopFetchingLocation()V
    ...
    iget-object v1, p0, Lcom/qrcode/scanner/generator/utils/AppLocationUtils;->mGoogleApiClient:Lcom/google/android/gms/common/api/GoogleApiClient;
